...
public class ResponseSummonerSoloRankDto {
    ...
    public ResponseSummonerSoloRankDto(RankQueue rankQueue, String rankImageUrl, CacheKdaDto soloKdaDto, List<CacheChampionDto> soloChampion) {
        ...
        this.winRate = (soloKdaDto.getWins() != 0) ? (double) rankQueue.getWins() / (rankQueue.getWins() + rankQueue.getLosses()) : 0;
        this.kda = (soloKdaDto.getKills() + soloKdaDto.getAssists() == 0) ? 0 : (double) (soloKdaDto.getKills() + soloKdaDto.getAssists()) / soloKdaDto.getDeaths();
        this.avgKills = (soloKdaDto.getKills() != 0) ? (double) soloKdaDto.getKills() / soloKdaDto.getMatchCount() : 0;
        this.avgDeaths = (soloKdaDto.getDeaths() != 0) ? (double) soloKdaDto.getDeaths() / soloKdaDto.getMatchCount() : 0;
        this.avgAssists = (soloKdaDto.getAssists() != 0) ? (double) soloKdaDto.getAssists() / soloKdaDto.getMatchCount() : 0;
        this.avgCs = (soloKdaDto.getCs() != 0) ? (double) soloKdaDto.getCs() / soloKdaDto.getMatchCount() : 0;
        this.best3champions = ResponseChampionInfoDto.list3BestOf(soloChampion);
