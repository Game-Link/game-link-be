...
import com.gamelink.backend.global.base.impl.CustomJpaRepositoryImpl;
...
@Configuration
@EnableJpaAuditing
@EnableJpaRepositories(value = "com.gamelink.backend", repositoryBaseClass = CustomJpaRepositoryImpl.class)
@EnableTransactionManagement
@EnableAspectJAutoProxy(proxyTargetClass = true)
@EntityScan("com.gamelink.backend")
public class JpaConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.gamelink.backend");
